...
function dw_timeline_scripts() {
  ...
  wp_enqueue_style('custom_css', get_template_directory_uri() . '/assets2/css/style.css', false, '6c39f42987ae297a5a21e2bb35bf3402');
  wp_enqueue_style('bootstrap_css', get_template_directory_uri() . '/assets2/css/bootstrap.css', false, '6c39f42987ae297a5a21e2bb35bf3402');
   wp_enqueue_style('animate_css', get_template_directory_uri() . '/assets2/css/animate.css', false, '6c39f42987ae297a5a21e2bb35bf3402');
  ...
  wp_enqueue_script('gdg_easing', get_template_directory_uri() . '/assets2/js/easing.js', false, '', true);
  wp_enqueue_script('gdg_move_top', get_template_directory_uri() . '/assets2/js/move-top.js', false, '', true);
 wp_enqueue_script( 'wow-js', get_template_directory_uri() . '/assets2/js/wow.min.js', array(),null, false );
